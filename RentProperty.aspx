<%@ Page Title="Rent Property" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RentProperty.aspx.cs" Inherits="RentManagement.RentProperty" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <asp:GridView ID="PropertyGrid" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="SqlDataSource1" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" AllowPaging="True" AllowSorting="True">
      ...
      <Columns>
          ...
          <asp:BoundField DataField="Term2To" HeaderText="Term2To" InsertVisible="true" SortExpression="Term2To" />
